...
header_button.addEventListener("click", function () {
    ...
    if (header.classList.contains("open")) {
        ...
        header_button.querySelector("img").src = "close-button.png";
    }
});
function open_photo() {
    let src = this.querySelector("img").src,
        popup_photo = document.querySelector("#popup-photo");
    popup_photo.querySelector("img").src = src;
    popup_photo.classList.add("open");
}
function close_popup() {
    document.querySelector("header").classList.remove("open")
    header_button.querySelector("img").src = "icon.png"
}
function add_photo() {
...
document.querySelector("#show_add_photo").addEventListener("click", add_photo, false);
document.querySelector("#cancel").addEventListener("click", close_photo, false);
document.querySelector("#add_photo").addEventListener("click", function () {
    ...
    if (src) {
        ...
        new_p.innerText = text ? text : "Слово РУМ и слово смерть...";
...
document.querySelector("#popup-photo").addEventListener("click", function () {
